...
# initalize my phone hotspot
initNet("NSA Surveilance Station 5", "ichbineinwlanschnorrer")
# set net var
print("Setting variable on server now")
setNetVar("andys_netvar", "SketchingWithHardware")
# get net var
print("Retreiving variable from server now")
net_var = getNetVar("andys_netvar")
# print retrieved net var
print("Retreived: " + net_var)
